...
export default function TopNav({ user }: { user: TopNavUser | null }) {
  ...
  const tabs     = isChild ? CHILD_TABS : TABS
  ...
  return (
    <div className="topbar">
      ...
      {user.role === 'PARTNER' && <span className="nav-readonly" title="Partner access — viewing only, plus Actuals import">Read-only</span>}
