...
const SAMPLE_CSV = `01/05/2026,WOOLWORTHS,-142.50
03/05/2026,NETFLIX.COM,-22.99
04/05/2026,COLES,-87.40
05/05/2026,SALARY CREDIT,9176.00
06/05/2026,PARTNER SALARY,4436.40
07/05/2026,AGL GAS,-102.00
08/05/2026,TELSTRA MOBILE,-43.00
10/05/2026,PETBARN,-89.00
12/05/2026,MCDONALDS,-24.50
    ...
    <div className="page">
      <div className="two-col">
            ...
            <div style={{ marginTop: '1rem' }}>
              ...
              >
                ...
                <div style={{ padding: '0.6rem 1.2rem', borderTop: '1px solid var(--border)', background: 'var(--surface2)', display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <span className="small">Commits merge into running history and rebuild budget suggestions</span>
                </div>
              </Panel>
            </div>
          )}
        ...
        <div>
          ...
          >
            <div style={{ fontSize: '0.74rem', color: 'var(--t2)', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 'var(--r)', padding: '0.6rem 0.8rem', marginBottom: '0.85rem', lineHeight: 1.5 }}>
              <strong style={{ color: 'var(--t1)' }}>How this affects your projections</strong><br />
              Importing transactions updates your <em>spending history only</em> — it does not change Projections directly. When enough months of data are collected, suggestions appear below. <strong>Accepting a suggestion</strong> updates the matching Budget expense line, which then flows through to Projections and Cashflow automatically.
            </div>
