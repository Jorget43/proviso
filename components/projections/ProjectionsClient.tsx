      ...
      <div className="sidebar-layout">
        ...
        <div>
          ...
          <div style={{ marginTop: '1rem' }}>
            <Panel title="Grace's income by year" dotColor="var(--pink)">
              <GraceIncomeChart
        ...
        {/* ── Sidebar ── */}
        <div>
          <Panel title="Grace's working pattern" dotColor="var(--pink)">
            <GraceTimeline
          ...
          <div style={{ marginTop: '1rem' }}>
            <Panel title="Income & wage growth" dotColor="var(--blue)">
              <Slider label="Grace wage growth / yr"  id="graceGrowth"  min={0} max={15} step={0.5} value={settings.graceGrowth}  cls="green-t" />
              <Slider label="Jorge wage growth / yr"  id="jorgeGrowth"  min={0} max={15} step={0.5} value={settings.jorgeGrowth}  cls="blue-t"  />
            </Panel>
          </div>
            ...
            <Panel title="Projection summary" dotColor="var(--purple)">
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: '0.74rem' }}>
                {[
                  ...
                  ...(income.graceHasHELP ? [{ label: 'Grace HELP cleared', val: main.helpClearedYr ? String(main.helpClearedYr) : `Beyond ${settings.projYears}yr horizon`, color: main.helpClearedYr ? 'var(--teal)' : '' }] : []),
                ].map(({ label, val, color }) => (
